...
const DEFAULT_SETTINGS: TandoorRecipesSettings = {
	mySetting: "default",
};
...
export default class TandoorRecipesPlugin extends Plugin {
	...
	async onload() {
		...
		ribbonIconEl.addClass("tandoor-recipes-ribbon-class");
...
class TandoorRecipesSettingTab extends PluginSettingTab {
	plugin: TandoorRecipesPlugin;

	constructor(app: App, plugin: TandoorRecipesPlugin) {
		super(app, plugin);
		this.plugin = plugin;
	}
